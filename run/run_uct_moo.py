...
def run_all(algo_dict, output_file="results_local"):
    ...
    for n_run in range(N_RUNS):
        ...
        df.to_csv(f"results/pareto-mcts/pareto_mcts_{SEARCH_SPACE}_{DATASET}.csv")
        df_hv = pd.DataFrame(hypervolumes)
        df_hv.to_csv(f"results/pareto-mcts/pareto_mcts_{SEARCH_SPACE}_{DATASET}_hv.csv")
