...
def run_all(algo_dict, output_file="results_local"):
    ...
    for n_run in range(N_RUNS):
        ...
        df.to_csv(f"results/uct_{SEARCH_SPACE}_{DATASET}.csv")
        df_hv = pd.DataFrame(hypervolumes)
        df_hv.to_csv(f"results/uct_{SEARCH_SPACE}_{DATASET}_hv.csv")
...
if __name__ == '__main__':
    algorithms = {
        ...
        # "Pareto-NRPA_PolicyRepresentation": {
        #     "algorithm": ParetoNRPAPolicyRepresentation,
        #     "config": CfgNode({
        #         "df_path": "none",
        #         "search": {
        #             "level": 3,
